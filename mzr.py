...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+1(604)373-2154?text=' + tks)

        

    r1=requests.get("https://github.com/https://github.com/JaMaLi001/tp").text
    ...
    if key1 in r1:
        ...
        os.system('am start https://wa.me/+923341284416?text=' + tks)
...
logo="""\033[1;37m
 ...
 [$]~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~[$]
    ...
    Facebook : Facebook.com/BARFI IS HERE
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/BARFI-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/BARFI-CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[BARFI]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      ALHAMDOLILLAH ❤️ \033[1;37m")
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+1(604)373-2154")
